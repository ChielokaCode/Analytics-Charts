...
import com.chielokacodes.userorgapp.utils.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain httpSecurity(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authRequests -> authRequests
                        .requestMatchers("/api/auth/**", "/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs.yaml","/v3/api-docs/**", "/").permitAll()
